 ...
 * Use display:table-cell instead of display:block for today, clear and name (#2121)
 ...
 * Fix datepicker name not centered when displaying calendar weeks (Fixes: #1625)
 ...
 * Add the posibility to have a name on the picker (Fixes: #1410)
