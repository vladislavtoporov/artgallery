...
# A shorter name for the navigation bar.  Default is the same as html_title.
#html_short_title = None

# The name of an file file (relative to this directory) to place at the top
# of the sidebar.
#html_logo = None

# The name of an file file (within the static path) to use as favicon of the
...
# (source start file, target name, name, author, documentclass [howto/manual]).
latex_documents = [
  ('index', 'bootstrap-datepicker.tex', u'bootstrap-datepicker Documentation',
   u'eternicode', 'manual'),
]

# The name of an file file (relative to this directory) to place at the top of
# the name page.
#latex_logo = None
...
# (source start file, target name, name, author,
