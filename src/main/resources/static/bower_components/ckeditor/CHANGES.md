...
* [#662](https://github.com/ckeditor/ckeditor-dev/issues/662): Introduced file inlining for the [Paste from Word](https://ckeditor.com/cke4/addon/pastefromword) plugin.
...
* [#995](https://github.com/ckeditor/ckeditor-dev/issues/995): Fixed: Hyperlinked file gets inserted twice by [Paste from Word](https://ckeditor.com/cke4/addon/pastefromword) plugin.
...
* [#16912](https://dev.ckeditor.com/ticket/16912): Fixed: Exception thrown when a single file is pasted using [Paste from Word](https://ckeditor.com/cke4/addon/pastefromword).
...
* [#13812](https://dev.ckeditor.com/ticket/13812): Fixed: When aborting file upload the placeholder for file is left.
...
* [#13816](https://dev.ckeditor.com/ticket/13816): Introduced a new strategy for Filling Character handling to avoid changes in DOM. This fixes the following issues:
	...
	* [#13513](https://dev.ckeditor.com/ticket/13513): [Blink, WebKit] [Div Editing Area](https://ckeditor.com/cke4/addon/divarea) and [`editor.getData()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-method-getData) throw an error when an file is the only data in the editor.
...
* [#13885](https://dev.ckeditor.com/ticket/13885): Fixed: [Enhanced Image](https://ckeditor.com/cke4/addon/image2) requires the [Link](https://ckeditor.com/cke4/addon/link) plugin to link an file.
...
* [#13361](https://dev.ckeditor.com/ticket/13361): Fixed: Skin images fail when the site path includes parentheses because the `background-file` path needs single quotes around the URL value.
...
* [#13300](https://dev.ckeditor.com/ticket/13300): Fixed: The `internalCommit` argument in the [Image](https://ckeditor.com/cke4/addon/file) dialog seems to be never used.
...
* [#13015](https://dev.ckeditor.com/ticket/13015): Fixed: Dropping an file file on [Enhanced Image](https://ckeditor.com/cke4/addon/image2) causes a page reload.
...
* [#13454](https://dev.ckeditor.com/ticket/13454): Removed unused `lang.file.alertUrl` token from the [Image](https://ckeditor.com/cke4/addon/file) plugin.
...
* Clipboard (copy&paste, drag&drop) and file uploading features and improvements ([#11437](https://dev.ckeditor.com/ticket/11437)).
  ...
  * Other changes and related fixes:
    ...
    * [#11219](https://dev.ckeditor.com/ticket/11219): Fixed: Dragging a [captioned file](https://ckeditor.com/cke4/addon/image2) does not fire the [`editor#paste`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-event-paste) event.
...
* [#13351](https://dev.ckeditor.com/ticket/13351): Fixed: Link lost when editing a linked file with the Link tab disabled. This also fixed a bug when inserting an file into a fully selected link would throw an error ([#12847](https://dev.ckeditor.com/ticket/12847)).
...
* [#12515](https://dev.ckeditor.com/ticket/12515): Fixed: Cursor is in the wrong position when undoing after adding an file and typing some text.
...
* [#12377](https://dev.ckeditor.com/ticket/12377): Fixed: Errors thrown in the [Image](https://ckeditor.com/cke4/addon/file) plugin when removing preview from the dialog window definition. Thanks to [Axinet](https://github.com/Axinet)!
...
* [#12398](https://dev.ckeditor.com/ticket/12398): Fixed: [Maximize](https://ckeditor.com/cke4/addon/maximize) does not work on an instance without a [name](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.config-cfg-name).
...
* [#12402](https://dev.ckeditor.com/ticket/12402): [Blink] Fixed: Workaround for Blink bug with `document.name` which breaks updating name in the full HTML mode.
...
* [#12111](https://dev.ckeditor.com/ticket/12111): Fixed: Linked file attributes are not read when opening the file dialog window by doubleclicking.
...
* [#12204](https://dev.ckeditor.com/ticket/12204): Fixed: Editor's voice label is not affected by [`config.name`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.config-cfg-name).
...
* [SCAYT](https://github.com/WebSpellChecker/ckeditor-plugin-scayt/issues/69): Fixed: Error thrown in the console after enabling [SCAYT](https://ckeditor.com/cke4/addon/scayt) and trying to add a new file.
...
* [#10867](https://dev.ckeditor.com/ticket/10867): Fixed: Issue with setting encoded URI as file link.
...
* [#11910](https://dev.ckeditor.com/ticket/11910): Fixed: [Enhanced Image](https://ckeditor.com/cke4/addon/image2) does not take [`config.baseHref`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.config-cfg-baseHref) into account when updating file dimensions.
...
* [#11223](https://dev.ckeditor.com/ticket/11223): Fixed: Issue when [Protected Source](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.config-cfg-protectedSource) was not working in the `<name>` element.
...
* [#11813](https://dev.ckeditor.com/ticket/11813): Fixed: Link lost while pasting a captioned file and restoring an undo snapshot ([Enhanced Image](https://ckeditor.com/cke4/addon/image2)).
...
* [#11880](https://dev.ckeditor.com/ticket/11880): [IE8-9] Fixed: Linked file has a default thick border.
...
* [#11300](https://dev.ckeditor.com/ticket/11300): Various changes in the [Enhanced Image](https://ckeditor.com/cke4/addon/image2) plugin:
  ...
  * Default file caption can be translated (customized) with the `editor.lang.image2.captionPlaceholder` string.
* [#11341](https://dev.ckeditor.com/ticket/11341): [Enhanced Image](https://ckeditor.com/cke4/addon/image2) plugin: It is now possible to add a link to any file type.
...
* [#11225](https://dev.ckeditor.com/ticket/11225): Introduced the [`CKEDITOR.tools.transparentImageData`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.tools-property-transparentImageData) property which contains transparent file data to be used in CSS or as file source.
...
* [#11727](https://dev.ckeditor.com/ticket/11727): Fixed: The editor tries to select a non-editable file which was clicked.
...
* [#11283](https://dev.ckeditor.com/ticket/11283): [Enhanced Image](https://ckeditor.com/cke4/addon/image2): A `<div>` element with `text-align: center` and an file inside is not recognised correctly.
...
* [Enhanced Image](https://ckeditor.com/cke4/addon/image2) button, context menu, command, and icon names match those of the [Image](https://ckeditor.com/cke4/addon/file) plugin ([#11222](https://dev.ckeditor.com/ticket/11222)).
...
* [#11159](https://dev.ckeditor.com/ticket/11159): [IE9-10] [Enhanced Image](https://ckeditor.com/cke4/addon/image2): Fixed buggy discovery of file dimensions.
* [#11101](https://dev.ckeditor.com/ticket/11101): Drop-down lists no longer break when given double quotes.
* [#11077](https://dev.ckeditor.com/ticket/11077): [Enhanced Image](https://ckeditor.com/cke4/addon/image2): Empty undo step recorded when resizing the file.
* [#10853](https://dev.ckeditor.com/ticket/10853): [Enhanced Image](https://ckeditor.com/cke4/addon/image2): Widget has paragraph wrapper when de-captioning unaligned file.
...
* [#10055](https://dev.ckeditor.com/ticket/10055): [IE8-10] Fixed: *Delete* pressed on a selected file causes the browser to go back.
...
* [#10836](https://dev.ckeditor.com/ticket/10836): [Enhanced Image](https://ckeditor.com/cke4/addon/image2): Preserve custom mouse cursor while resizing the file.
* [#10939](https://dev.ckeditor.com/ticket/10939): [Firefox] [Enhanced Image](https://ckeditor.com/cke4/addon/image2): hovering the file causes it to change.
...
* [#10430](https://dev.ckeditor.com/ticket/10430): Resolve dependence of the [Image](https://ckeditor.com/cke4/addon/file) plugin on the [Form Elements](https://ckeditor.com/cke4/addon/forms) plugin.
...
* [#10659](https://dev.ckeditor.com/ticket/10659): New [Enhanced Image](https://ckeditor.com/cke4/addon/image2) plugin that introduces a widget with integrated file captions, an option to center images, and dynamic "click and drag" resizing.
...
* [#10704](https://dev.ckeditor.com/ticket/10704): Fixed a JAWS issue with the Select Color dialog window name not being announced.
...
* [#10042](https://dev.ckeditor.com/ticket/10042): Introduced [`config.name`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.config-cfg-name) setting to change the human-readable name of the editor.
...
* Minor issues in plugin integration with Advanced Content Filter:
  ...
  * [#10195](https://dev.ckeditor.com/ticket/10195): [Image](https://ckeditor.com/cke4/addon/file) plugin no longer registers rules for links to Advanced Content Filter.
...
* [#9882](https://dev.ckeditor.com/ticket/9882): Fixed empty document name on [`editor.getData()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-method-getData) if set via the Document Properties dialog window.
